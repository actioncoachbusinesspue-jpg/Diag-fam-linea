-- MIGRACIÓN 0001 — esquema inicial (idéntico a database/schema.sql).
-- Una instalación nueva puede importar schema.sql O esta migración: son
-- equivalentes. Ver database/migrations/README.md para la política.
